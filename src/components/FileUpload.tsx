...
//       setError("Please select a file less than 20MB.");
//       return false;
...
// interface FileUploadProps {
//   onSuccess: (url: string) => void; // Expects the final URL
//   onProgress?: (progress: number) => void;
//   fileType?: "image" | "video";
//   label?: string; // Optional label for the input
//   disabled?: boolean; // To disable upload from parent
// }
...
//       <label htmlFor="file-upload" className="text-white text-sm font-sans mb-2">
//         {label}
//       </label>
//       <input
//         id="file-upload"
...
//       {selectedFile && (
//         <p className="text-gray-300 text-sm mt-1">Selected: {selectedFile.name}</p>
//       )}
...
//         {uploading ? (
//           <>
//             <Loader2 className="animate-spin h-4 w-4 mr-2" /> Uploading ({uploadProgress}%)
//           </>
//         ) : (
//           "Upload File"
//         )}
