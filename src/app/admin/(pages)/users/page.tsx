// // app/admin/users/page.tsx or components/AdminUsersPage.tsx
// "use client";
...
//           <div className="max-h-[calc(100vh-410px)] overflow-y-auto">
//             <Table>
...
//                             user.isVerified ? "bg-green-700/20 text-green-300 border-green-700/40" : "bg-red-700/20 text-red-300 border-red-700/40"
//                           }`}
//                         >
...
//                         <Badge
//                           className={`px-2 py-0.5 text-sm font-semibold uppercase ${roleBadgeClasses(user.role)}`}
//                         >
//                           {user.role}
//                         </Badge>
//                       </TableCell>
...
//                             className="h-8 w-8 transition-colors duration-200 bg-blue-500 hover:bg-blue-600"
//                             onClick={(e) => {
//                               e.stopPropagation();
