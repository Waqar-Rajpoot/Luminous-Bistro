...
// Define a type for the context object that Next.js passes as the second argument
// This matches Next.js's internal expectation for dynamic route parameters.
...
// GET a single menu by ID
// Corrected: Use the defined 'RouteContext' type for the second argument.
export async function GET(request: NextRequest, { params }: RouteContext) {
  ...
  try {
    // Corrected: Access menuId directly from the 'params' object (no 'await')
    const { menuId } = params;
