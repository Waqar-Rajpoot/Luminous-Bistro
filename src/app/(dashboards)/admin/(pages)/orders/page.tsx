...
/**
 * Formats a number into currency based on locale and provided currency code.
 */
...
const OrderPage = () => {
  ...
  // Filter recent orders based on recent search term
  const filteredRecentOrders = useMemo(() => {
    if (!recentSearchTerm) {
      return recentOrders;
    }
    const lowerCaseSearch = recentSearchTerm.toLowerCase();
  ...
  return (
    <>
      <div className="min-h-screen bg-[#141F2D] p-4 sm:p-8 text-[#EFA765] font-sans">
        {/* TOP HEADER */}
              ...
              <CardHeader className="flex flex-col md:flex-row items-start md:items-center justify-between space-y-4 md:space-y-0 p-0 mb-4">
                ...
                <div className="w-full md:w-auto">
                  <SearchBar
                    ...
                    setSearchTerm={setRecentSearchTerm}
                  />
                </div>
              </CardHeader>
              <CardContent className="p-0">
                {filteredRecentOrders.length > 0 ? (
                  ...
                  <div className="text-center text-white/70 py-5">
                    <p>
                      {recentSearchTerm
                        ? `No recent orders match "${recentSearchTerm}".`
